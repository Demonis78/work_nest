...
ActiveRecord::Schema[7.1].define(version: 20_240_903_074_743) do
  ...
  create_table 'reservations_variants', id: false, force: :cascade do |t|
    ...
    t.index %w[reservation_id variant_id], name: 'index_reservations_variants_on_reservation_id_and_variant_id',
                                           unique: true
